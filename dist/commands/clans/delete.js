...
class DeleteClanCommand extends Command_1.default {
    get options() {
    ...
    async execute(message, _) {
        ...
        if (!confirmMsg)
            return;
        main_1.activeClanDeletions.add(message.author.id);
        const confirm = await Util.confirm(confirmMsg, message.author);
        main_1.activeClanDeletions.delete(message.author.id);
...
exports.default = DeleteClanCommand;
