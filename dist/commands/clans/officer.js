...
class ClanOfficerCommand extends Command_1.default {
    get options() {
    ...
    async execute(message, args) {
        ...
        message.channel
            ...
            embed: {
                color: config.meta.defaultColor,
                description: `Ого, ${targetMember} теперь офицер. Надеюсь, что это заслуженно..\nВ любом случае, ждем твоих успехов в "@роль гильдии"!`,
                image: { url: 'https://i.imgur.com/bykHG7j.gif' }
            }
        })
...
exports.default = ClanOfficerCommand;
