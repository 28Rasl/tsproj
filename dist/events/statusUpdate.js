...
exports.MemberRemove = exports.MemberAdd = void 0;
const discore_js_1 = require("discore.js");
const Util = __importStar(require("../utils/util"));
class MemberAdd extends discore_js_1.Event {
    get options() {
...
class MemberRemove extends discore_js_1.Event {
    get options() {
...
exports.MemberRemove = MemberRemove;
