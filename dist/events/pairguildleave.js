...
class DeletePair extends discore_js_1.Event {
    get options() {
    ...
    run(member) {
        if (!Util.verifyMainGuild(member.guild.id))
            return;
        const loveroom = loveroom_1.default.resolve(member.id);
        if (!loveroom)
            return;
        loveroom.delete();
    }
}
exports.default = DeletePair;
//# sourceMappingURL=pairguildleave.js.map